...
import { Lock, Mail, Building2, Loader2, Shield } from "lucide-react";
import { useState } from "react";
import { useAuth } from "@/modules/auth/hooks/useAuth";
import { useCambiarContrasena } from "@/modules/perfiles/hooks/usePerfiles";

const ConfiguracionEmpleador = () => {
            ...
            <CardContent className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    value={perfil?.perfilEmpleador?.nombreEmpresa || ""}
                    disabled
...
export default ConfiguracionEmpleador;
