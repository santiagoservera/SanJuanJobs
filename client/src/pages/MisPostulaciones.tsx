...
const MisPostulaciones = () => {
  ...
  useEffect(() => {
    if (!isAuthenticated) {
      ...
      toast.error("Solo los empleados pueden ver sus postulaciones");
      navigate("/");
    }
              ...
              <Card>
                <CardContent className="p-12 text-center">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Empezá a explorar trabajos disponibles y postulate a los que
                    te interesen
                  </p>
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex items-center gap-4 text-sm text-muted-foreground mb-2">
                                <div className="flex items-center gap-1">
                                  ...
                                  <span>
                                    {postulacion.trabajo.empleador
                                      .perfilEmpleador?.nombreEmpresa ||
                                      "Empresa"}
                                  </span>
                                </div>
                                <div className="flex items-center gap-1">
                              ...
                              <div className="flex items-center gap-1 text-xs text-muted-foreground">
                                ...
                                <span>
                                  Postulado el{" "}
                                  {formatearFecha(postulacion.fechaCreacion)}
                                </span>
                              </div>
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    ...
                                    {postulacion.trabajo.titulo}". Esta acción
